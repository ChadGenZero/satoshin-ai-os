...
const ShutdownSequence: React.FC<ShutdownSequenceProps> = ({
    ...
    ${_M}
    I literally built this workspace to teach you about Bitcoin.
    You can read the Bitcoin Whitepaper, complete Lessons, or Talk to Satoshi... but all you wanna do is shut the computer down.
    ${_L}
    |Goodbye Again!|
    ${_M}
